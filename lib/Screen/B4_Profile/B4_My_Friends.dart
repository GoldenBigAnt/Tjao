    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: <Widget>[
            Padding(
                padding: const EdgeInsets.only(left: 10.0, top: 20, right: 10.0, bottom: 10.0),
    ...
    return Padding(
        ...
        child: Column(
          ...
          children: list.map<Widget>((friend) {
            return (friend.req_id > 0 && friend.req_status == 1)
                ? Padding(
